  ...
  Widget _buildMealLog() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Meal Log', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          SizedBox(height: 16),
          _buildMealItem(),
          _buildMealItem(),
          _buildMealItem(),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Meal score: 82', style: TextStyle(fontWeight: FontWeight.bold)),
  ...
  Widget _buildMacroBreakupItem(String macro, double value, Color color) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text('$macro Breakup', style: TextStyle(fontWeight: FontWeight.bold)),
          ),
          Expanded(
            flex: 2,
