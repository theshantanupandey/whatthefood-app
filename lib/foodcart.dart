...
class _FoodCartState extends State<FoodCart> {
  ...
  Widget _buildBillingDetails() {
    int itemTotal = orderItems.fold(0, (sum, item) => sum + item.price * item.qty);
    int deliveryFee = 25;
    int totalSavings = 125;
    int convenienceFee = 3;
    int gstAndCharges = 10;
    int payable = itemTotal + deliveryFee - totalSavings + convenienceFee + gstAndCharges;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBillingRow('Total Savings', '-₹$totalSavings', isSavings: true),
  ...
  Widget _buildBillingRow(String title, String amount, {bool isSavings = false, bool isTotal = false}) {
    return Padding(
