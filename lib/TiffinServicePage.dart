...
class TiffinServicePage extends StatelessWidget {
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildMealSection('Breakfast', '530-1170', 'assets/breakfast.png', context),
                _buildMealSection('Lunch', '255-600', 'assets/lunch.png', context),
                _buildMealSection('Dinner', '530-1170', 'assets/dinner.png', context),
              ],
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final day = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][index % 7];
  ...
  Widget _buildMealSection(String meal, String calories, String imagePath, BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            ClipRRect(
              borderRadius: BorderRadius.circular(8),
              child: Image.asset(imagePath, width: 180, height: 140, fit: BoxFit.cover),
            ),
          ],
        ),
      ),
