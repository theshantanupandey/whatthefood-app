...
class AddressPage extends StatelessWidget {
      ...
      child: Column(
        children: [
          _buildAddressItem(
            ...
            icon: Icons.home,
            title: 'Home',
            address: '1276D, Ranjit Nagar, Kharar bus stand,\nnear, New Aman city, Kharar\n140301',
          ),
  ...
  Widget _buildAddressItem(BuildContext context,
      {required IconData icon, required String title, required String address}) {
    return Padding(
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 8,
                            children: ['Home', 'Work', 'Hotel', 'Friends/Family', 'Other']
                                .map((type) => ChoiceChip(
                              label: Text(type),
