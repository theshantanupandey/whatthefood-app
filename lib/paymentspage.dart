...
class PaymentPage extends StatelessWidget {
  ...
  Widget _buildAddNewCard() {
    return Card(
      ...
      child: ListTile(
        contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
        leading: Icon(
            Icons.add_circle_outline, color: Colors.orange[700], size: 32),
        title: Text(
            'Add new card', style: TextStyle(fontWeight: FontWeight.bold)),
        trailing: Row(
  ...
  Widget _buildWalletItem(String name, String number, String balance,
      String logo) {
    return Card(
      elevation: 2,
      margin: EdgeInsets.only(bottom: 16.0),
      ...
      child: ListTile(
        ...
        trailing: balance.startsWith('₹')
            ...
            : TextButton(
          child: Text(balance, style: TextStyle(color: Colors.deepOrange[700])),
          onPressed: () {},
        ),
      ),
    );
